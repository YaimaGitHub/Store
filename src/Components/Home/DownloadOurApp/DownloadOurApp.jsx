  ...
  <div className="flex items-center xl:space-x-5 lg:space-x-4 space-x-4">
    ...
    <a href="#">
      <div className="bg-black p-2.5 rounded-md">
        <img src={appleStore || "/placeholder.svg"} className="xl:h-7 md:h-6 h-5" alt="appleStore" />
      </div>
    </a>
    ...
    <a href="#">
      <div className="bg-black p-2.5 rounded-md">
        <img src={playStore || "/placeholder.svg"} className="xl:h-7 md:h-6 h-5" alt="playStore" />
      </div>
    </a>
  </div>
)
