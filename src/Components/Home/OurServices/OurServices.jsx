...
const OurServicesList = () => {
  ...
  return (
    ...
    <ul className="lg:max-w-[22rem] sm:max-w-[20rem] sm:p-0 px-1 md:space-y-2 space-y-1">
      {[
        new Service(0, t("services.service1"), truck),
        new Service(1, t("services.service2"), location),
        new Service(2, t("services.service3"), headphones),
        new Service(3, t("services.service4"), price),
      ].map((service) => (
        <li
          key={service.id}
        ...
        >
          <img className="xl:h-9 lg:h-8 h-7 my-auto" src={service.icon || "/placeholder.svg"} alt={service.name} />
          <div>
